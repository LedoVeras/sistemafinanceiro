package com.ledo.sistemafinanceiro.exceptionsHandler;

import com.ledo.sistemafinanceiro.exceptionsHandler.exceptions.DatabaseException;
import com.ledo.sistemafinanceiro.exceptionsHandler.exceptions.ResourceNotFoundException;
import com.ledo.sistemafinanceiro.exceptionsHandler.exceptions.InvalidDataException;
...
public class ResourceExceptionHandler {
    ...
    static {
        ...
        exceptionMap.put(InvalidDataException.class, new HttpStatusWrapper(HttpStatus.BAD_REQUEST, "Dados inválidos fornecidos"));
